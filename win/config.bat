...
(
echo # this file is auto-generated by github.com/jwu/settings
echo source: "%MY_ROOT_ESCAPED%\\lsd.yaml"
...
:: copy omnisharp.json
copy /Y "%MY_ROOT%\omnisharp.json" "%USERPROFILE%\.omnisharp\omnisharp.json"
...
:: copy zed settings
copy /Y "%MY_ROOT%\zed.settings.json" "%APPDATA%\zed\settings.json"
